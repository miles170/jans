...
class ScimInstaller(JettyInstaller):
    ...
    def __init__(self):
        ...
        self.source_files = [
                ...
                (os.path.join(Config.install_dir, 'setup_app/data/jans-scim-openapi.yaml'), 'https://raw.githubusercontent.com/JanssenProject/jans/main/jans-scim/server/src/main/resources/jans-scim-openapi.yaml'),
                ]
